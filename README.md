...
| Шаг | Экран | Описание |
|-----|-------|----------|
| 1 | ![Главная](./public/screenshots/main_page.png) | **Главная страница** — стартовая точка приложения|
| 2 | ![Настройки](./public/screenshots/settings.png) | **Настройки** — выбор AI провайдера (Groq, Claude, Gemini, DeepSeek) .  Добавляте ключи для DeepGram (расшифровка) и выбранной AI для суммаризации текста |
| 3 | ![Загрузка](./public/screenshots/upload_page.png) | **Загрузка видео или аудио** — выбор файла для обработки |
| 4 | ![Редактор](./public/screenshots/videoEditor.png) | **Видео редактор** — обрезка видео/ аудио. выбираете что нужно расшифровать, если не хотите расшифровывать полный файл|
| 5 | ![Выбор языка](./public/screenshots/choose_language.png) | **Выбор языка** — настройка распознавания речи . Обязательно выберите русский, если будете расшифровывать видео на русском |
| 6 | ![Транскрибация](./public/screenshots/transcription_result.png) | **Результат транскрибации** — видео → текст |
| 7 | ![Суммаризация](./public/screenshots/summary_view.png) | **Суммаризация** — текст → краткое содержание, привязка к таймкодам, выводы |

**Полный путь:** Главная → Настройки → Загрузка видео → Редактор видео → Выбор языка → Транскрибация → Суммаризация
