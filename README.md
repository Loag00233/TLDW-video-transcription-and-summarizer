...
| 2 | ![Настройки](./public/screenshots/settings.png) | **Настройки** — выбор AI провайдера (Groq, Claude, Gemini, DeepSeek) |
| 3 | ![Загрузка](./public/screenshots/upload_page.png) | **Загрузка видео** — выбор файла для обработки |
| 4 | ![Редактор](./public/screenshots/videoEditor.png) | **Видео редактор** — обрезка и настройка видео |
| 5 | ![Выбор языка](./public/screenshots/choose_language.png) | **Выбор языка** — настройка распознавания речи |
| 6 | ![Транскрибация](./public/screenshots/transcription_result.png) | **Результат транскрибации** — видео → текст |
| 7 | ![Суммаризация](./public/screenshots/summary_view.png) | **Суммаризация** — текст → краткое содержание |
